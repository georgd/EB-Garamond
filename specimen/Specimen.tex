...
This special treatment of f-ligatures can be switched off by enabling feature \texttt{cv08}. Beware, you’ll get all sorts of ligatures:  {\addfontfeature{Language=German, CharacterVariant=8}Laufband, aufjagen, Sauerstoffflasche,…}
...
%% due to a bug in fontspec this doesn’t work as expected in XeLaTeX while it does in LuaLaTeX:
