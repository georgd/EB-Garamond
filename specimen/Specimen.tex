...
+tlig,-ccmp,+mkmk}}%,Numbers={Proportional,OldStyle}}
...
\end{greek}\\
\begin{greek}[variant=ancient]\addfontfeature{RawFeature=+cv80}
...
\paragraph*{Standard Ligatures} (feature \texttt{liga}, on by default): f and ſ + letter with ascender and f/ſ+i get replaced by a ligature, as well as T+h: fluffy, Théatre, ſhy;\\
...
\textit{v → {\addfontfeature{RawFeature=+cv05:1}v}}, \textit{\addfontfeature{RawFeature=+cv05:2}v}, \textit{\addfontfeature{RawFeature=+cv05:3}v}
...
Planned: alternate β, ε, θ, κ, π, ρ, σ, φ; alternate circumflex (inverted breve shape);
