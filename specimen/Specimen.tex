...
\paragraph*{cv81:} prosgegrammeni instead of ipogegrammeni: ᾞ → {\addfontfeature{CharacterVariant=81:1} ᾞ} → {\addfontfeature{CharacterVariant=81:2} ᾞ} (this too only works together with \textsc{ss20} which decomposes precomposed glyphs)\\
