...
\paragraph*{Contextual Ligatures} (feature \texttt{clig}, on by default, italic only): ligatures for final s after a, e, i and u: \textit{%\addfontfeature{RawFeature=+clig}
