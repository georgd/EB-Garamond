...
\paragraph*{cv21} Variants for ß: first Variant sets all ß to the ß-shape, second to ss: \textsc{{\fontspec[CharacterVariant=21:1]{EBGaramond}ß} {\fontspec[CharacterVariant=21:2]{EBGaramond}ß}}
