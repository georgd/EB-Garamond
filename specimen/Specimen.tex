...
+tlig,+ccmp}}%,Numbers={Proportional,OldStyle}}
...
\paragraph*{cv80:} \addfontfeature{RawFeature=+ss20}alternate circumflex: ῆ ἧ → {\addfontfeature{RawFeature=+cv80}ῆ ἧ} (only works together with \ŧextsc{ss20} which decomposes precomposed glyphs)\\
